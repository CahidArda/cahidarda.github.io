...
export default function AssetGraph() {
  ...
  const gateColor =
    phase < 2 ? 'var(--color-line-strong)' : phase === 2 ? EVAL : passed ? PASS : FAIL;
    ...
    <Widget title="Data-quality gate" kicker="snapshot → rollup → [gate] → promote">
      ...
      >
        ...
        <SvgNode
          ...
          sub="per tenant/day"
          color={EVAL}
          state={phase === 1 ? 'active' : phase >= 1 ? 'wait' : 'off'}
          titleSize={11}
        />
        ...
        <polygon
          points={diamond}
          style={{
            fill: phase === 3 ? gateColor : 'var(--color-paper)',
            stroke: gateColor,
            strokeWidth: 2,
        ...
        <text
          ...
          style={{
            fill: phase === 3 ? 'var(--color-paper)' : 'var(--color-ink-soft)',
