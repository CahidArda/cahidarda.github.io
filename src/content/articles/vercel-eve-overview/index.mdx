...
- Chat SDK: the platform [channels](#communicating-with-the-agent-channels) —
  Slack, Discord, Telegram, and web chat — run on
  [Chat SDK](https://chat-sdk.dev/), a unified SDK for shipping a bot to every chat
  platform from one codebase.
...
The DX felt considered. You deploy, open the page, and it shows you how to connect
to the agent right there. The rest was just as easy to set up.).
